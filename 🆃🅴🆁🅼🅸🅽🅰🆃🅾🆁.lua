...
function HOME()
SN = gg.choice({
   "╭───────────────────────────────────|\n📂ₜₑᵣₘᵢₙₐₜₒᵣ☞ₘₐₑₗₛₜᵣₒₘ(ᴸᵒᵇᵇʸ)☠️ʜᴇɴʀʏ ꜱ ꜱᴄʀɪᴘᴛ☠️ㅤㅤㅤㅤ🇭​\n╰───────────────────────────────────|",
   "╭───────────────────────────────────|\n📂ₜₑᵣₘᵢₙₐₜₒᵣ ᵢₙ ₘₐₑₗₛₜᵣₒₘ(ᴵⁿᵍᵃᵐᵉ)☠️ʜᴇɴʀʏ ꜱ ꜱᴄʀɪᴘᴛ☠️ㅤㅤㅤ🇪​\n╰───────────────────────────────────|",
   "╭───────────────────────────────────|\n📂FᵤₙCₜᵢₒₙ FᵣₑₑZₑ ₚᵢₛₜₒₗ(ᴸᵒᵇᵇʸ)☠️ʜᴇɴʀʏ ꜱ ꜱᴄʀɪᴘᴛ☠️ㅤㅤㅤㅤ🇳​\n╰───────────────────────────────────|",
   "╭───────────────────────────────────|\n📂ₘₛg₃₃↬FᵣₑₑZₑ ₚᵢₛₜₒₗ(ᴵⁿ ᵍᵃᵐᵉ)☠️ʜᴇɴʀʏ ꜱ ꜱᴄʀɪᴘᴛ☠️ㅤㅤㅤㅤ🇷​\n╰───────────────────────────────────|",
   "╭───────────────────────────────────|\n📂🅰🅸🅼🅱🅾🆃 ☞ (ᴵⁿ ᵍᵃᵐᵉ)☠️ʜᴇɴʀʏ ꜱ ꜱᴄʀɪᴘᴛ☠️ㅤㅤㅤㅤ🇾​\n╰───────────────────────────────────|",
   "ㅤㅤㅤㅤㅤㅤ╭───────────────────────────╮\n ㅤㅤㅤㅤㅤㅤㅤ☠️━─━──── E⃢​    X⃢​    I⃢​    T⃢─────━─━☠️\nㅤㅤㅤㅤㅤㅤ╰───────────────────────────╯",
	 }, nil, "🇭​🇪​🇳​🇷​🇾​ 🇸​ 🇲​🇴​🇩​ 🇸​🇨​🇷​🇮​🇵​🇹​ 🇭​🇦​🇨​🇰​ㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤ☠️🅴🆂🅿🅴🅲🅸🅰🅻 🆂🅲🆁🅸🅿🆃 🆃🅴🆁🅼🅸🅽🅰🆃🅾🆁 🅽🅴🆆 🅼🅴🅽🆄 1.6.7 🆅17 🅱🆈 🅷🅴🅽🆁🆈 🆂 🅾🅿☠️.")
if SN == nil then else
if SN==1 then  HENRY1() end
if SN==2 then HENRY2() end
if SN==3then HENRY3() end
if SN==4 then HENRY4() end
if SN==5 then HENRY5() end
...
gg.setRanges(gg.REGION_C_ALLOC)
gg.searchNumber("34.0F;134.0F;59.0F;64.0F;39.0F:21", gg.TYPE_FLOAT, false, gg.SIGN_EQUAL, 0, -1, 0)
gg.processResume()
gg.refineNumber("59", gg.TYPE_FLOAT, false, gg.SIGN_EQUAL, 0, -1, 0)
revert = gg.getResults(46, nil, nil, nil, nil, nil, nil, nil, nil)
gg.editAll("-179", gg.TYPE_FLOAT)
