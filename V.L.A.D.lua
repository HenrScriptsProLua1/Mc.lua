...
function HOME()
SN = gg.choice({
   "╭────────────────╮\n📂ₘₐₑₗₛₜᵣₒₘ ᵥ.ₗ.ₐ.D (ₗₒBBY)    ☠️ʜᴇɴʀʏ ꜱ ꜱᴄʀɪᴘᴛ☠️\n╰────────────────╯",
   "╭────────────────╮\n📂v.l.a.d ᵢₙ ₘₐₑₗₛₜᵣₒₘ(ᴵⁿ ᵍᵃᵐᵉ) ☠️ʜᴇɴʀʏ ꜱ ꜱᴄʀɪᴘᴛ☠️\n╰────────────────╯",
   "╭────────────────╮\n📂FᵤₙCₜᵢₒₙ FᵣₑₑZₑₚᵢₛₜₒₗ(ᴸᵒᵇᵇʸ)☠️ʜᴇɴʀʏ ꜱ ꜱᴄʀɪᴘᴛ☠️\n╰────────────────╯",
   "╭────────────────╮\n📂ₘₛg₃₃↬FᵣₑₑZₑ ₚᵢₛₜₒₗ(ᴵⁿᵍᵃᵐᵉ)☠️ʜᴇɴʀʏ ꜱ ꜱᴄʀɪᴘᴛ☠️\n╰────────────────╯",
   "╭────────────────╮\n📂🅰🅸🅼🅱🅾🆃☞(ᴵⁿ ᵍᵃᵐᵉ)☠️ʜᴇɴʀʏ ꜱ ꜱᴄʀɪᴘᴛ☠️\n╰────────────────╯",
   "ㅤㅤㅤㅤㅤㅤㅤㅤ╭───────────────────────────╮\n ㅤㅤㅤㅤㅤㅤㅤㅤ☞☠️━─━──── E⃢​    X⃢​    I⃢​    T⃢─────━─━☠️☞\nㅤㅤㅤㅤㅤㅤㅤㅤ╰───────────────────────────╯",
...
t = nil
gg.clearResults()
gg.toast('V.L.A.D 𝐑𝐀𝐓𝐄 𝐎𝐅 𝐅𝐈𝐑𝐄 𝐇𝐈𝐆𝐇')
end
...
gg.clearResults()
gg.setRanges(gg.REGION_C_ALLOC)
gg.searchNumber("74", gg.TYPE_FLOAT, false, gg.SIGN_EQUAL, 0, -1, 0)
revert = gg.getResults(5000, nil, nil, nil, nil, nil, nil, nil, nil)
gg.editAll("-181", gg.TYPE_FLOAT)
gg.clearResults()
gg.toast("v.l.a.d CODE FREEZE 🥶")
end


function HENRY3()
gg.setRanges(gg.REGION_C_ALLOC)
gg.searchNumber("35.0F;534.0F;834.0F:49", gg.TYPE_FLOAT, false, gg.SIGN_EQUAL, 0, -1, 0)
gg.processResume()
...
gg.searchNumber("34.34999847412", gg.TYPE_FLOAT, false, gg.SIGN_EQUAL, 0, -1, 0)
r = gg.getResults(1)
gg.clearResults()

local t = {}
t[1] = {}
t[1].address = r[1].address  +  0xA00
t[1].flags = 16
t[1].value = 36.5
t[1].freeze = true
gg.setValues(t)
